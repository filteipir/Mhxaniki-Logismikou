...
public class LoginPanel extends JPanel {
	...
	private String usertypes[] = {"диавеияистгс", "пекатгс", "упаккгкос", "летажояеас"};
	...
	public LoginPanel() {
		setOpaque(false);
		setLayout(new MigLayout("", "[grow][200][grow]", "[grow][10][10][10][10][10][grow]"));
		ImageIcon image = new ImageIcon("image/a.png"); 
		
		JLabel lblMetaforikiLogin = new JLabel(image);
		lblMetaforikiLogin.setBackground(Color.green);
		lblMetaforikiLogin.setFont(new Font("Arial", Font.BOLD, 15));
