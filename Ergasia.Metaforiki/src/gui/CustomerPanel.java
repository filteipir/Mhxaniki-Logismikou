...
public class CustomerPanel extends JPanel {
	...
	public CustomerPanel() {
		...
		JLabel lblNewLabel = new JLabel("еуяесг пайетоу");
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD | Font.ROMAN_BASELINE, 12));
		add(lblNewLabel, "cell 1 1,alignx center,aligny center");
		
		JLabel lblTypeThe = new JLabel("еисацацете том йыдийо тоу пайетоу");
		...
		lblInputATracking = new JLabel("еисацацете том йыдийо тоу пайетоу");
		lblInputATracking.setForeground(Color.RED);
		lblInputATracking.setVisible(false);
		add(lblInputATracking, "cell 1 4,h 15");
		
		lblWrongFormatMust = new JLabel("г еисацыцг пяепеи ма еимаи тупоу: RBxxxxxxxxxGR");
