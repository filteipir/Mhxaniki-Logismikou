...
public class IpalilosPanel extends JPanel {
	...
	private String[] columnNames = { "Surname", "Last Name", "Address", "Postal Code","Country","Phone","Fragile","Tracking","Comments", "Status" };
	...
	public IpalilosPanel() {
		...
		tabbedPane.addTab("Õ≈œ –¡ ≈‘œ", null, panel, null);
		...
		JLabel lblCountry = new JLabel("◊Ÿ—¡");
		...
		JLabel lblFragile = new JLabel("≈’»—¡’”‘œ");
		...
		btnClear = new JButton(" ¡»¡—…”Ãœ”");
		panel.add(btnClear, "cell 1 16,alignx left,growy");

		btnSubmit = new JButton("≈…”¡√Ÿ√«");
		...
		tabbedPane.addTab("¡Õ¡∆«‘«”«", null, panel_1, null);
		...
		JLabel lblName1 = new JLabel("œÕœÃ¡");
		...
		JLabel lblSurname1 = new JLabel("≈–…»≈‘œ");
		...
		JLabel lblAddress1 = new JLabel("ƒ…≈’»’Õ”«");
		...
		JLabel lblPostalCode1 = new JLabel("‘. ");
		...
		lblSearchWarnig4 = new JLabel("O T.K –—≈–≈… Õ¡ ≈…Õ¡… 5ÿ«÷…œ”");
