...
public class MainPanel {
    ...
    public static void main(String[] args) {
        ...
        frame.getContentPane().add(ipalilos, "упаккгкос");
        frame.getContentPane().add(metaforeas, "летажояеас");
        frame.getContentPane().add(customer, "пекатгс");
        frame.getContentPane().add(admin, "диавеияистгс");
